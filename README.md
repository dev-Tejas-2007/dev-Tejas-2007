...
class TejasNirgude:
    def __init__(self):
        self.name = "Tejas Nirgude , yes i am good in coding "
...
## <img src="https://media.giphy.com/media/hvRJCLFzcasrR4ia7z/giphy.gif".github/workflows/snake.yml width="28"> Connect With Me
